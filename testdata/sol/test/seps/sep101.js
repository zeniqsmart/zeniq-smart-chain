...
contract("SEP101", async (accounts) => {
    ...
    it('get/set: from EOA', async () => {
        const sep101 = new ISEP101("0x0000000000000000000000000000000000002712"); // ZENIQ live2022
        // still valid after CCRPCForkBlock but in addition to
        // const sep101 = new ISEP101("0x000000000000000000000000005a454e49510003");
        try {
