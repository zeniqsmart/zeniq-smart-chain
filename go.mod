module github.com/zeniqsmart/zeniq-smart-chain
...
replace github.com/zeniqsmart/evm-zeniq-smart-chain => ../evm-zeniq-smart-chain
...
replace github.com/zeniqsmart/zeniq-smart-chain => ../zeniq-smart-chain
