...
import (
	...
	"github.com/zeniqsmart/zeniq-smart-chain/seps"
)
...
func TestTransferFrom_drainBCH(t *testing.T) {
	...
	initAmt := testutils.HexToU256("0xde0b6b3a7640000") // 1 ZENIQ
...
func TestTransferFrom_mustLeaveMargin(t *testing.T) {
	...
	minMargin := testutils.HexToU256("0x38d7ea4c68000") // 0.001Zeniq
